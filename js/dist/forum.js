...
/*!******************!*\
  !*** ./forum.js ***!
  \******************/
/*! exports provided: UserDirectoryPage */
...
var UserDirectoryPage = /*#__PURE__*/function (_Page) {
  ...
  _proto.init = function init() {
    ...
    if (flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.previous instanceof UserDirectoryPage) {
      flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.cache.fofUserDirectoryList = null;
    }

    var params = this.params();

    if (flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.cache.fofUserDirectoryList) {
      // Compare the requested parameters (sort, search query) to the ones that
      // are currently present in the cached discussion list. If they differ, we
      // will clear the cache and set up a new discussion list component with
      // the new parameters.
      Object.keys(params).some(function (key) {
        if (flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.cache.fofUserDirectoryList.props.params[key] !== params[key]) {
          flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.cache.fofUserDirectoryList = null;
          return true;
        }
      });
    ...
    if (!flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.cache.fofUserDirectoryList) {
      flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.cache.fofUserDirectoryList = new _UserDirectoryList__WEBPACK_IMPORTED_MODULE_13__["default"]({
        params: params
      });
    }
  ...
  _proto.view = function view() {
    return m("div", {
    ...
    }, m("ul", null, flarum_helpers_listItems__WEBPACK_IMPORTED_MODULE_5___default()(this.sidebarItems().toArray()))), m("li", {
      "class": "item-search"
    }, m("div", {
      "class": "Search active"
    }, m("div", {
      ...
      "class": "Search-clear Button Button--icon Button--link"
    }, m("i", {
      "class": "icon fas fa-times-circle "
    }))), m("ul", {
      "class": "Dropdown-menu Search-results"
    }))), m("div", {
    ...
    }, flarum_helpers_listItems__WEBPACK_IMPORTED_MODULE_5___default()(this.viewItems().toArray())), m("ul", {
      className: "IndexPage-toolbar-action"
    }, flarum_helpers_listItems__WEBPACK_IMPORTED_MODULE_5___default()(this.actionItems().toArray()))), flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.cache.fofUserDirectoryList.render()))));
  };
  ...
  _proto.navItems = function navItems() {
    ...
    items.add('fof-user-directory', flarum_components_LinkButton__WEBPACK_IMPORTED_MODULE_11___default.a.component({
      href: flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.route('fof_user_directory', params),
  ...
  _proto.viewItems = function viewItems() {
    ...
    var sortMap = flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.cache.fofUserDirectoryList.sortMap();
    var sortOptions = {};

    for (var i in sortMap) {
      sortOptions[i] = flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('fof-user-directory.forum.page.sort.' + i);
    }

    items.add('sort', flarum_components_Select__WEBPACK_IMPORTED_MODULE_9___default.a.component({
      options: sortOptions,
  ...
  _proto.changeSort = function changeSort(sort) {
    ...
    if (sort === Object.keys(flarum_app__WEBPACK_IMPORTED_MODULE_2___default.a.cache.fofUserDirectoryList.sortMap())[0]) {
      delete params.sort;
    } else {
      params.sort = sort;
    }
...
flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.initializers.add('fof-user-directory', function (app) {
  app.routes.fof_user_directory = {
    path: '/users',
    component: _components_UserDirectoryPage__WEBPACK_IMPORTED_MODULE_5__["default"].component()
  };
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_UsersSearchSource__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'view', function (view, query) {
    ...
    view.splice(1, 0, m("li", null, flarum_components_LinkButton__WEBPACK_IMPORTED_MODULE_3___default.a.component({
      icon: 'fas fa-search',
      children: app.translator.trans('fof-user-directory.forum.search.users_heading', {
        query: query
      }),
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_IndexPage__WEBPACK_IMPORTED_MODULE_4___default.a.prototype, 'navItems', function (items) {
    if (app.forum.attribute('canSeeUserDirectoryLink')) {
      items.add('fof-user-directory', flarum_components_LinkButton__WEBPACK_IMPORTED_MODULE_3___default.a.component({
        href: app.route('fof_user_directory'),
